...
<head>
	...
	<title><?php echo 'Po(S)T '  . $this->lang->line('common_powered_by') . ' Software Troopers ' ?></title>
	...
	<?php } ?>
		...
		<script type="text/javascript" src="dist/opensourcepos.min.js?rel=5eed5e63a9"></script>
		...
		<div class="topbar">
			<div class="container">
				...
				<div class="navbar-center" style="text-align:center">
					<strong><?php echo 'Software Troopers'; ?></strong>
				</div>
			</div>
		</div>
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand hidden-sm" href="<?php echo site_url(); ?>">Software Troopers</a>
				</div>
